...
La presente investigación se desarrolla en colaboración con un equipo de analistas
políticos y comunicadores especializados en procesos electorales peruanos, cuyo interés es
contar con un sistema automatizado de inteligencia electoral que permita monitorear la
percepción pública nacional durante la campaña presidencial, identificar los temas
relevantes emergentes y detectar narrativas de desinformación en tiempo real, empleando
...
\begin{table}[htbp]
    \caption[Fuentes de datos del sistema de inteligencia electoral]{Fuentes de datos del sistema de inteligencia electoral y su rol en el pipeline de análisis.}
    \label{tab:fuentes_datos}
    \footnotesize
    \centering
    \begin{tabular}{M{3.5cm}M{4.5cm}M{6cm}}
        \specialrule{.1em}{.05em}{.05em}
        \textbf{Fuente} & \textbf{Tipo de dato} & \textbf{Rol en el sistema} \\
        \specialrule{.1em}{.05em}{.05em}
        X (antes Twitter) & Publicaciones, retweets, menciones & Fuente primaria de análisis de sentimientos y detección de temas \\[5pt]
        \hline
        Facebook & Publicaciones y comentarios públicos & Fuente complementaria de percepción ciudadana \\[5pt]
        \hline
        Portales de noticias digitales & Artículos y titulares & Contexto informativo y detección de desinformación \\[5pt]
        \hline
        YouTube & Comentarios en videos políticos & Análisis de sentimientos en formato audiovisual \\[5pt]
        \hline
        ONPE / JNE & Datos electorales históricos & Validación y correlación de indicadores \\[5pt]
        \hline
        Encuestas de opinión & Datos de intención de voto & Calibración y validación del modelo \\
        \specialrule{.1em}{.05em}{.05em}
    \end{tabular}
    \begin{flushleft}
...
\textbf{Recursos Clave}: Modelos LLM pre-entrenados (GPT, Llama, BERT
multilingüe); infraestructura de cómputo en la nube (GPU para inferencia en tiempo real);
acceso a APIs de redes sociales y portales de noticias; equipo multidisciplinario de
científicos de datos, analistas políticos y desarrolladores.
...
\textbf{Estructura de Costos}: Costos de acceso a APIs de redes sociales y datos; costos
de infraestructura computacional en la nube (GPU, almacenamiento); costos de personal
técnico y analítico; costos de licenciamiento de modelos LLM de terceros; costos de
desarrollo y mantenimiento de la plataforma de visualización.
