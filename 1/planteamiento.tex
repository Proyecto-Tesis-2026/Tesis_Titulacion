...
¿De qué manera un sistema de inteligencia electoral basado en LLMs, grafos de conocimiento y enfoque multi-fuente mejora el análisis de la percepción pública en contextos electorales digitales?
}
\ProblemaGeneral
...
\newcommand{\Pbtwo}{¿El enfoque multi-fuente mejora la representatividad del análisis de la percepción pública?}
...
\newcommand{\Objtwo}{Analizar el impacto de integrar múltiples fuentes digitales en la representatividad del análisis de percepción pública.}
...
El uso de modelos de lenguaje de gran escala (LLMs), grafos de conocimiento y enfoque multi-fuente mejora significativamente la precisión, contextualización y capacidad explicativa del análisis de la percepción pública en entornos electorales digitales.
}
\HipotesisGeneral
...
\newcommand{\Htwo}{La integración multi-fuente incrementa la diversidad temática y la cobertura del análisis de percepción pública.}
