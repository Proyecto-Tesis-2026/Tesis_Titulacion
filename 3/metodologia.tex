...
Con el fin de evaluar el desempeño de los módulos del sistema, correspondiente a la quinta fase de la metodología CRISP-DM, se emplearon varias medidas de medición como instrumentos para medir su rendimiento. A continuación, se describen su definición y fórmulas de cálculo.
...
\begin{itemize}
    ...
    positivas donde el sistema predice correctamente. Esta calcula con la siguiente Ecuación
    \ref{eq:recall_llm}:
    ...
    \item \textbf{Coherencia semántica $C_v$}: Métrica estándar utilizada para la evaluación de la calidad de
    ...
    \item \textbf{Correlación de Pearson con encuestas}: Permite medir el grado de correlación
    lineal  existente entre el Índice de Sentimiento Neto (ISN) calculado por el sistema para cada
    candidato y los distintos resultados obtenidos por parte de las encuestas sobre la intención de voto disponibles durante el
...
La selección de las métricas mencionadas para evaluar cada módulo del sistema se llevó a cabo tras comparar aquellas empleadas por parte de los los autores en presentación de los antecedentes del estudio propuesto:
