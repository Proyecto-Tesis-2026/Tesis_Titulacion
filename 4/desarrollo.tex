...
% \begin{figure}[!ht]
%     \begin{center}
%         \includegraphics[width=1\textwidth]{4/figures/pipeline_temas_llm.png}
%         \caption[Pipeline de detección dinámica de temas con LLM y retrieval multinivel]{Pipeline de detección dinámica de temas electorales: construcción del menú de cinco \textit{tiers} (\textit{trending}, semántico, léxico, actor y evento), llamada concurrente al LLM, \textit{override} semántico contra el catálogo y dedup intra-\textit{batch} previo al \textit{upsert}.\\
%             Fuente: Elaboración propia.}
%         \label{5:fig18}
%     \end{center}
% \end{figure}
...
% \begin{figure}[!ht]
%     \begin{center}
%         \includegraphics[width=0.90\textwidth]{4/figures/temas_consolidate_dedup.png}
...
% \begin{figure}[!ht]
%     \begin{center}
%         \includegraphics[width=0.95\textwidth]{4/figures/graphrag_typed_tools_mcp.png}
