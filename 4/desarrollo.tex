...
\begin{figure}[!ht]
    \begin{center}
        ...
        \caption[Función principal del scraper de noticias digitales electorales]{Función principal del scraper de noticias digitales electorales, mostrando la lógica de extracción por portal y el almacenamiento en la tabla \texttt{documentos\\Fuente: Elaboración propia.}
        \label{5:fig1}
    \end{center}
\end{figure} de la capa Bronze.}
...
\begin{figure}[!ht]
    \begin{center}
        ...
        \caption[Módulo de ingesta asíncrona de Twitter/X mediante TwitterAPI.io]{Módulo de ingesta asíncrona de Twitter/X mediante TwitterAPI.io, mostrando el consumo REST con \texttt{httpx\\Fuente: Elaboración propia.}
        \label{5:fig3}
    \end{center}
\end{figure}, el filtrado temporal por \texttt{createdAt} y la persistencia de archivos JSON raw en la capa Bronze.}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig6b_scraper_tiktok}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig7_distribucion_fuentes}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig12_pipeline_limpieza}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig14_embeddings_pipeline}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig15_filtros_pre_llm}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig16_prompt_absa}}
        \caption[Prompt de análisis de sentimientos a nivel de aspecto para el contexto electoral peruano]{Prompt de análisis de sentimientos a nivel de aspecto (\textit{Aspect-Based Sentiment Analysis\\Fuente: Elaboración propia.}
        \label{5:fig16}
    \end{center}
\end{figure}) diseñado para el contexto electoral peruano, con estructura role-context-task-format-examples y salida en JSON estructurado.}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig17_prompt_structure}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig18_pipeline_temas_llm}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig19_consolidate_dedup}}
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig22_graphrag_mcp}}
...
etiquetado de validación que excede el alcance temporal de esta tesis y se
documenta como trabajo futuro en el archivo \texttt{docs/pendientes-evaluacion.md}
del repositorio \texttt{electoral-intelligence}.
...
preguntas anotadas con su \textit{ground truth} de tool esperada (ver
...
trabajo futuro (ver \texttt{docs/pendientes-evaluacion.md}, sección 4).
...
\begin{figure}[!ht]
    \begin{center}
        \resizebox{\textwidth}{!}{\input{4/figures/fig24_demo_flux}}
