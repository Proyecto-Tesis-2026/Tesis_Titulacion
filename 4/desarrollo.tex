...
(src/electoral/ingestion/youtube.py), siguiendo un patrón
...
obtienen la metadata completa, filtran por \texttt{upload\_date\_iso} y almacenan
los resultados. Las transcripciones automáticas se identifican por el flag
\texttt{is\_auto\_generated}. El scraper tolera el formato compacto de fecha
...
entre workers por round-robin para evitar bloqueos por límite de tasa.
...
transcripciones y comentarios asociados para su posterior análisis. En la Figura
...
pyahocorasick, permite buscar todos los aliases de todos los candidatos en el
