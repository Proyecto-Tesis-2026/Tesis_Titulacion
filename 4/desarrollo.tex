...
\subsection{Desarrollo de actividades. Aplicación de herramientas de solución}

A continuación se documenta la implementación de la solución, organizada en
tres bloques de actividades: la construcción del corpus multi-fuente, la
preparación y enriquecimiento de los datos, y el modelamiento de los módulos
analíticos del sistema. Cada bloque presenta los cálculos, fragmentos de código
y diagramas que materializan la propuesta sobre la arquitectura Medallion del
pipeline GraphRAG Electoral.

% ──────────────────────────────────────────────────────────────
\subsubsection{Construcción del corpus multi-fuente}
% ──────────────────────────────────────────────────────────────
...
% ──────────────────────────────────────────────────────────────
\subsubsection{Preparación y normalización del corpus}
% ──────────────────────────────────────────────────────────────
...
% ──────────────────────────────────────────────────────────────
\subsubsection{Modelamiento de los módulos analíticos}
% ──────────────────────────────────────────────────────────────
...
\subsection{Análisis de Indicadores cuantitativo y/o cualitativo}
...
\subsection{Simulación de solución. Aplicación de Software}
