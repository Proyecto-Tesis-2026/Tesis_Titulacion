...
digital multi-fuente. El sistema PeruVox integra tres fuentes de datos digitales
—noticias de portales de prensa, publicaciones de X/Twitter y comentarios de
YouTube—, procesa hasta 3,200 publicaciones por minuto durante picos de actividad
electoral y genera indicadores de percepción pública en tiempo real con una
correlación de Pearson de $r = 0.74$ ($p < 0.05$) respecto a encuestas electorales
convencionales, confirmando la hipótesis general de la investigación.
...
y Gold) sobre una infraestructura dual de bases de datos —PostgreSQL con pgvector
para datos relacionales y vectoriales, y Neo4j para el grafo de conocimiento—.
La integración de múltiples fuentes de datos demostró que cada canal aporta una
perspectiva complementaria: las noticias digitales reflejaron la agenda mediática,
X/Twitter capturó la reacción ciudadana inmediata y los comentarios de YouTube
proporcionaron opiniones de mayor longitud y elaboración argumentativa. El sistema
Aho-Corasick de filtrado, implementado como primer estadio del pipeline, redujo el
costo computacional del análisis LLM en aproximadamente un 40\% al descartar
eficientemente los segmentos sin menciones a candidatos.
...
se limitó a tres fuentes digitales, sin incluir TikTok —plataforma de creciente
influencia política entre la población joven peruana— ni medios audiovisuales
tradicionales. La triangulación de los resultados del ISN con encuestas
