...
valores en el rango $[-0.20, 0.20]$ se clasifican como neutros. Como ejemplo de
caso de uso real del sistema, se realizó la siguiente consulta al servidor MCP
desde un cliente LLM en lenguaje natural:
...
se muestra en la Figura \ref{6:fig12}.
