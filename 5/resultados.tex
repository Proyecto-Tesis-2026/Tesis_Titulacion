...
\begin{table}[h!]
    ...
    \begin{flushleft}
        ...
        * Correlación de Pearson calculada entre el ISN semanal y tres encuestas electorales del período. [cite: 1933] \\
        ...
        \textsuperscript{1} El sistema PeruVox utilizará DeepSeek-Chat como modelo LLM principal (con Gemini Flash como \textit{fallback}), seleccionado por su mecanismo de caché de prefijo que reducirá el costo operacional hasta en un 75\% para prompts con prefijos invariantes largos [cite: 1934]. Los resultados reportados corresponderán a la configuración DeepSeek-Chat few-shot con cuatro ejemplos, estadísticamente equivalente a Gemini Flash few-shot (diferencia en F1 macro $< 0.002$).
    \end{flushleft}
\end{table}
