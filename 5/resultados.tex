...
\figpendiente{6:fig10}{Sistema PeruVox en ejecución durante el segundo debate presidencial}{Sistema PeruVox en ejecución durante el segundo debate presidencial: pantalla del cliente MCP mostrando la evolución del ISN en tiempo real y los temas emergentes detectados en la cobertura mediática.}
...
\figpendiente{6:fig12}{Consulta GraphRAG en lenguaje natural sobre los resultados del debate presidencial}{Resultado de una consulta GraphRAG en lenguaje natural sobre el impacto del debate presidencial en la percepción proyectada por los medios, con la respuesta fundamentada en fragmentos textuales del corpus original.}