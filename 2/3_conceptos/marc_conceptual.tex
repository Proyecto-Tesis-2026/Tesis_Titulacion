...
La \textbf{polaridad} es la dimensión evaluativa fundamental del análisis de sentimientos, que indica la orientación afectiva de un texto hacia una entidad o aspecto determinado: positiva, negativa o neutral \parencite{mc_liu2012sentiment}. En el contexto de la cobertura mediática electoral, la polaridad mide si un artículo periodístico, tweet de un medio, video de YouTube o publicación de TikTok expresa apoyo, rechazo o una posición indefinida respecto a un candidato, partido político, propuesta o evento de la campaña.
